...
class _RolesPageState extends State<RolesPage> {
  ...
  Future<void> _load() async {
    ...
    final prefsRol = await AuthStorage.getEmpresa(); // reutiliza key empresa como rol simple
    ...
    return Scaffold(
      ...
      body: _loading ? const Center(child: CircularProgressIndicator()) : ListView(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(value: _rol, decoration: const InputDecoration(border: OutlineInputBorder(), labelText: 'Rol'), items: const [DropdownMenuItem(value: 'usuario', child: Text('Usuario')), DropdownMenuItem(value: 'supervisor', child: Text('Supervisor')), DropdownMenuItem(value: 'admin', child: Text('Admin'))], onChanged: (v) => setState(() => _rol = v)),
